...
- **Organize code into clearly separated modules**, grouped by features.
...
Always use strictly validate with pydantic v2
...
- **Commit early and often** - Regular commits help track progress and easy rollback when mistakes happen

## 🔍 Search Command Requirements

**CRITICAL**: Always prefer to use `rg` (ripgrep) instead of traditional `grep` and `find` commands:
